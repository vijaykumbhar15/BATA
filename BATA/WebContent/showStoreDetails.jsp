...
<h2>Store Details</h2><br><br>
	<table class="table table-striped">
		...
		<tbody>
			...
			String query="SELECT st.storeID,st.storeName,sta.stateName,dt.districtName,emp.fname,emp.lname from storemaster as st join statemaster as sta join districtmaster as dt join employeemaster as emp WHERE st.stateID=sta.stateID and st.distID=dt.districtID and st.SM_ID=emp.empID";			
			...
			while(rs.next())
			{
				...
				<tr>
					...
					<td>
						<a class="button-style1" onClick="return confirm();" href='editStore.jsp?storeID=<%=rs.getString("StoreID") %>'>Edit</a>
						<a class="button-style2" href='deleteStore.jsp?storeID=<%=rs.getString("StoreID") %>'>Delete</a>
					</td>
				</tr>
